...
public class Pessoa {
    ...
    public manytoone_unidirecional_tabela_associativa.Endereco getEndereco() {
        return endereco;
    }

    public void setEndereco(manytoone_unidirecional_tabela_associativa.Endereco endereco) {
